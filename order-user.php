...
<div class="container page-header " style="min-height:400px;" >
  ...
  <div class="col-md-3 col-sm-6 col-xs-12  pull-left left_order text-center" style="background-color: #c1e2b3 ">
     <h3>orders</h3>
     <hr/>
     ...
     <form id="send_user_order" method="post">
       ...
       <div class="row">
         <textarea class="nodes form-control" name="nodes" style=" height: 250px; width: 250px;"></textarea><br/>
       </div>
         <br><br>
       <div class="row">
  ...
  <div class="col-md-9 col-xs-12 pull-right right_order">
   ...
   <?php 
     ...
     <p class="clearfix"></p>
     <hr/>
      <h3 class="text-center">Choose your Prouduct</h3>
      <hr/>
