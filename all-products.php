...
<div class="table-responsive">
		...
		foreach($result as $row) {
				...
				$display=$row['display'];
				$image=$row['image'];
				echo "<tr id='row$product_id' height='10px'>";
				echo "<td>$product_name</td>";
				echo "<td>$product_price</td>";
				echo "<td><img class='img-rounded img-responsive thumb'  src='uploads/$image' ></td>";
				echo '<td>';

				echo '<a href="javascript:void(0);" class="text-primary" onclick="editProudct('.$product_id.')" id="edit'.$product_id.'"><i class="fa fa-pencil fa-3x"></i></a>';
				echo '<a href="javascript:void(0);" class="text-danger" onclick="deleteProudct('.$product_id.')" id="delete'.$product_id.'"><i class="fa fa-eraser fa-3x"></i></a><br>';
