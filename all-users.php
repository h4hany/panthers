...
<div class="row">
	...
	<h4 style="float: right"><a href="add-user.php"><img src="uploads/add-user.png" width="50px"></a></h4>
...
<div class="table-responsive">
		...
		foreach($result as $row) {
				...
				echo "<td>$ext</td>";
				echo '<td>';
				echo '<a href="javascript:void(0);" class="text-primary" onclick="editUser('.$user_id.')" id="edit'.$user_id.'"><i class="fa fa-pencil fa-3x"></i></a>';
				echo '<a href="javascript:void(0);" class="text-danger" onclick="deleteUser('.$user_id.')" id="delete'.$user_id.'"><i class="fa fa-trash fa-3x"></i></a>';
				echo '</td>';	
				echo "</tr>";
			}
